  ...
  <body>
          ...
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0 mt-2">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item" href="business-analysis.html"
                    >Business Analysis</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="scrum-analysis.html"
                    >Scrum master</a
                  >
                </li>
                <!-- <li>
    ...
    <div class="container mt-2 mt-md-5">
      <div class="row">
        ...
        <div class="col-12 col-md-6 text-center text-md-end">
          <img class="img-fluid main-image" src="Image/main_image.png" alt="" />
        </div>
      </div>
      <div class="row">
        <div class="col text-center">
          <p class="mt-5">
            <img class="img-tick" src="Image/tick-circle.png" alt="" />Discover
      ...
      <div class="container">
        <div class="row mt-4">
          ...
          <div class="row pb-5 pt-1">
            <div class="col text-center">
              <a href=""><img src="Image/Brand.png" alt="" /></a>
            </div>
            <div class="col text-center">
              <a href=""><img src="Image/Brand2.png" alt="" /></a>
            </div>
            <div class="col text-center">
              <a href=""><img src="Image/Frame 863.png" alt="" /></a>
            </div>
            <div class="col text-center">
    ...
    <div class="container">
      ...
      <div class="row mt-4 justify-content-center">
        <div
          class="col-12 col-md-6 d-flex justify-content-center justify-content-md-end mb-4 mb-md-0"
        >
          <div
            class="card me-md-5 shadow-sm index-course-card"
            style="width: 20rem"
          >
            <div class="container">
              <img src="Image/Agency.png" class="card-img-top pt-4" alt="..." />
              <div class="card-body text-center">
                ...
                <hr />
                <a class="package-btn" href="business-analysis.html">Explore Package</a>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div
            class="card ms-md-5 shadow-sm index-course-card"
            style="width: 20rem"
          >
            <div class="container">
              <img
              ...
              <div class="card-body text-center">
                ...
                <hr />
                <a class="package-btn" href="scrum-analysis.html">Explore Package</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row pt-4">
          ...
          >
            <div class="card team-card" style="width: 18rem">
              <img
                src="Image/WhatsApp Image 2025-01-29 at 04.56.06_1e3963c1.jpg"
                class="card-img-top img-team"
                alt="..."
              />
              <div class="card-body">
          ...
          >
            <div class="card team-card" style="width: 18rem">
              ...
              <div class="card-body">
                <div class="social-wrapper pt-3">
                  <h5 class="card-title">Dr O. Olukomaiya</h5>
                  <div class="social-icons">
                    <a href="#"><i class="bi bi-twitter"></i></a>
                    <a href="#"><i class="bi bi-facebook"></i></a>
                    <a href="#"><i class="bi bi-linkedin"></i></a>
      ...
      <div class="row mt-5">
        <div class="col">
          ...
          >
            ...
            <div
              class="nav-buttons-wrapper d-flex justify-content-center mb-2 mb-md-0 mt-3 mt-md-0 me-0 me-md-5"
            >
        ...
        <div class="col">
          <div class="swiper">
            <div class="swiper-wrapper">
              ...
              <!-- Additional swiper-slide cards can go here (like the other examples you provided) -->
            </div>
        ...
        <div class="row pt-5">
          <div class="col-lg-7">
            ...
            <div class="row mt-4 mb-5">
              <div class="col">
                <div>
                  <img class="consult-img" src="Image/image7.png" alt="" />
                </div>
              </div>
              <div class="col">
                <div class="book-wrapper">
                  ...
                  <div class="d-flex justify-content-end">
                    <img
                      ...
                      src="Image/Frame 1618868751.png"
                      alt=""
                    />
                  </div>
                </div>
