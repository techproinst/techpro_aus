          ...
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0 mt-2">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  <a class="dropdown-item" href="show.scrumMaster"
                    >Scrum master</a
                  >
                </li>
      ...
      <div class="row mt-4 justify-content-center">
        ...
        >
          ...
          >
            <div class="container">
              <img
                src="{{ asset('assets/images/Company.png') }}"
        ...
        <div class="row pt-4">
          ...
          >
            <div class="card team-card" style="width: 18rem">
              <img
                src="{{ asset('assets/images/WhatsApp Image 2025-01-29 at 04.56.06_1e3963c1.jpg') }}"
          ...
          >
            <div class="card team-card" style="width: 18rem">
              <img
                src="{{ asset('assets/images/aisha.jpg') }}"
                class="card-img-top img-team aisha"
                alt="..."
              />
              <div class="card-body">
                <div class="social-wrapper ">
          ...
          >
            <div class="card team-card" style="width: 18rem">
              <img
                src="{{ asset('assets/images/MIB[1].jpg') }}"
                class="card-img-top img-team"
                alt="..."
              />
              <div class="card-body">
              ...
              <div class="swiper-slide testimonial-card">
                <div class="card shadow-sm mb-3">
                  <div class="row g-0">
                    <div class="col-md-4">
                      <img
                        src="{{ asset('assets/images/Rectangle 8.png') }}"
              ...
              <div class="swiper-slide testimonial-card">
                <div class="card shadow-sm mb-3">
                  <div class="row g-0">
                    <div class="col-md-4">
                      <img
                        src="{{ asset('assets/images/Rectangle 7.png') }}"
