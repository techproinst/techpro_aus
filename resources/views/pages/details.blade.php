      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            @endphp
            <h6>Courses: @foreach ($courses as $course)

              <span>{{ Str::ucfirst(Str::lower($course->name ))}}</span><br>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                @php
                   $schedules = $payment->paymentSchedules
                @endphp
                ...
                <td>
                  <a href="{{ asset('upload/' . $payment->payment_receipt) }}" target="_blank">
                    <img class="img-fluid" style="height: 100px;"
                      src="{{ asset('upload/' . $payment->payment_receipt) }}" alt="">
                  </a>
                </td>
              ...
              <tr>
                <td colspan="9"><strong><a
                      href="{{ route('outstanding.payment', ['student' => $student->id]) }}">proceed to pay
                      balance</a></strong></td>
              </tr>
              @endif
            </tbody>
